...
import { generateInvoicePdf } from "@/engines/document";

/**
 * GET /api/documents/invoice/[id] — télécharge la facture en PDF.
...
export async function GET(
  ...
  try {
    ...
    console.error("[api/documents/invoice] Erreur:", e);
